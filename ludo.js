...
var socketId;
var twoPlayerGame = {gameId: null,
	diceIds:[{ uniqueId :"0fa40a32-8102-40be-85ae-595e7845d62a", value: 0 }, {uniqueId :"601b50bb-ed85-4323-8cfd-61262f924748", value : 0}],
		players :[{ piecesNames :["red","blue"], playerName :"Player One", hasRolled :false, index : 0, playerMode : 2, endOfPlay : 0,
			pieces:[{piece :"red", state : 0, index : 1, x :118, y:72, x_home:118, y_home:72, imageId:"red_piece", uniqueId :"8d4329e4-bb84-4ef5-97ec-593669ff197c", homeIndex:1 },
			        ...
			        {piece : "blue" , state :0, index :14, x :552, y :168, x_home :552, y_home :168, imageId :"blue_piece", uniqueId :"db947c8e-c8b4-4f8c-80bd-3698d0f8dfbf", homeIndex :14}],
			         ...
			         { piecesNames :["yellow","green"], playerName :"Player Two", hasRolled :false, index :1, playerMode :2, endOfPlay :0, 
...
function saveNewGame(data){
	...
	if (data.gameId === undefined ||  data.gameId === null){
		sock.emit('saveNewGame', 'Game ID: ' + data.gameId + ' Not Saved! Game Id Missing');
		return;
	}
	client.set(data.gameId, data.data, function(err, reply) {
		  ...
		  if (reply == 'OK'){
			  ...
			  sock.emit('saveNewGame', 'Game Not Saved!!! Sever Error');
		  }
	});
};

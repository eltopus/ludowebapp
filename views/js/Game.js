...
Ludo.Game.prototype = {
		...
		getConnectionTextPlayerName(color){
		...
		connectionNotificationAlert(playerName, status){
		...
		displayConnectionAlert(piece, status){
			switch(piece){
				case 'red':
				{
					if (status){
